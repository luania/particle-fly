...
var ContainerFactory = (function () {
    ...
    ContainerFactory.prototype.color = function (c) {
        return this.config.whatToDraw.monochrome ? Colors_1.Colors.white : c;
    };
    ...
    ContainerFactory.prototype.circular = function () {
        ...
        circle.beginFill(this.color(Colors_1.Colors.random()));
    ...
    ContainerFactory.prototype.star = function () {
        ...
        star.beginFill(this.color(Colors_1.Colors.random()));
        var points = [];
    ...
    ContainerFactory.prototype.starSakura = function () {
        var star = new PIXI.Graphics();
        star.beginFill(this.color(Colors_1.Colors.pink));
        var points = [];
        var size = this.randomSize();
    ...
    ContainerFactory.prototype.cross = function () {
        ...
        var size = this.randomSize();
        cross.beginFill(this.color(Colors_1.Colors.pink));
        cross.lineStyle(size / 10, this.color(Colors_1.Colors.pink));
        cross.moveTo(0, size);
        cross.lineTo(0, -size);
        cross.moveTo(size, 0);
        cross.lineTo(-size, 0);
