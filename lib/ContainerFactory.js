...
var ContainerFactory = (function () {
    ...
    ContainerFactory.prototype.circular = function () {
        ...
        circle.beginFill(this.monochrome ? Colors_1.Colors.white : Colors_1.Colors.random());
    ...
    ContainerFactory.prototype.star = function () {
        ...
        star.beginFill(this.monochrome ? Colors_1.Colors.white : Colors_1.Colors.random());
        var points = [];
    ...
    ContainerFactory.prototype.image = function (url) {
        var image = new PIXI.Sprite(PIXI.loader.resources[url].texture);
        var size = Math.random() * this.maxSize;
        image.width = size;
        image.height = size;
        image.anchor.x = 0.5;
